...
| Iteración | Cota inferior | Cota superior | Raíz aproximada | f(x_k) |
|:-------------:|:-------------:|:-------------:|:-------------:|:--------------|
...
: Iteraciones del método de Bisección (Tabla abreviada). {#tbl-biseccion-iteraciones}
...
: Iteraciones del método de Regula falsi (Tabla abreviada). {#tbl-regula-falsi-iteraciones}
...
: Iteraciones de Regula falsi (Tabla abreviada). {#tbl-regula-falsi-iteraciones-2}
...
: Iteraciones del método de la Secante. {#tbl-secante-iteraciones-2}
...
: Estancamiento de la cota superior en Regula falsi (Tabla abreviada). {#tbl-regula-falsi-iteraciones-3}
...
: El método de Illinois actualiza ambas cotas y converge rápidamente. {#tbl-illinois-iteraciones-3}
...
: Iteraciones de Punto fijo (Tabla abreviada). {#tbl-punto-fijo-iteraciones-4}
...
: Iteraciones del método de Steffensen. {#tbl-steffensen-iteraciones-4}
